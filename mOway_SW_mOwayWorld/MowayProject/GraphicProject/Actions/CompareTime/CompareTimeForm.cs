...
{
    public partial class CompareTimeForm : ActionForm
    {
        #region Attributes
...
this.action = action;
        ...
        {
            this.tbOutput.Text = CompareMessages.TRUE + " - " + CompareMessages.IF + " " + CompareTimeMessages.TIME + " " + CompareMessages.IS + " ";
            ...
            if (this.cbCompareVariable.SelectedIndex == 0)
                this.tbOutput.Text += " " + this.nudCompareValue.Value + " s";
            else
