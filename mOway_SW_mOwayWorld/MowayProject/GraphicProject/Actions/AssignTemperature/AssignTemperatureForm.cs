...
{
    public partial class AssignTemperatureForm : ActionForm
    {
        #region Attributes

        private AssignTemperatureAction action;

        #endregion

        public AssignTemperatureForm(AssignTemperatureAction action)
        {
            InitializeComponent();
            this.helpTopic = AssignTemperature.HelpTopic;
            this.action = action;
        }
