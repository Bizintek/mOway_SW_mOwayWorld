...
{
    public partial class CompareNoiseForm : ActionForm
    {
        #region Attributes

        private CompareNoiseAction action;
...
this.action = action;
        ...
        {
            this.tbOutput.Text = CompareMessages.TRUE + " - " + CompareMessages.IF + " " + CompareNoiseMessages.NOISE + " " + CompareMessages.IS + " ";
