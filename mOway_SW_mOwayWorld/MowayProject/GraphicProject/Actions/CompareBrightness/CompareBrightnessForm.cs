...
{
    public partial class CompareBrightnessForm : ActionForm
    {
        #region Attributes

        private CompareBrightnessAction action;
...
this.action = action;
        ...
        {
            this.tbOutput.Text = CompareMessages.TRUE + " - " + CompareMessages.IF + " " + CompareBrightnessMessages.BRIGHTNESS + " " + CompareMessages.IS + " ";
