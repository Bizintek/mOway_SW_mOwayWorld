...
{
    public class CompareBrightnessAction : Conditional
    {
        #region Attributes
        ...
        public CompareBrightnessAction(string key)
        {
            this.key = key;
        }
        ...
        {
            return new CompareBrightnessAction(this.key, this.operation, this.compareVariable, this.compareValue);
        }
        ...
        {
            writer.WriteLine(";************Module Compare Brightness*********************************");
            writer.WriteLine("");
            writer.WriteLine(";**********************************************************************");
            writer.WriteLine("");
