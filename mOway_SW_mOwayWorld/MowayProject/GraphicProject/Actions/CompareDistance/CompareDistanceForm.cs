...
{
    public partial class CompareDistanceForm : ActionForm
    {
        #region Attributes

        private CompareDistanceAction action;

        #endregion

        public CompareDistanceForm(CompareDistanceAction action)
        {
            InitializeComponent();
            this.helpTopic = CompareDistance.HelpTopic;
            this.action = action;
        }
        ...
        {
            this.tbOutput.Text = CompareMessages.TRUE + " - " + CompareMessages.IF + " " + CompareDistanceMessages.DISTANCE + " " + CompareMessages.IS + " ";
            ...
            if (this.cbCompareVariable.SelectedIndex == 0)
                this.tbOutput.Text += " " + this.nudCompareValue.Value + " cm";
            else
