...
{
    public partial class CompareAngleForm : ActionForm
    {
        #region Attributes
...
this.action = action;
        ...
        {
            this.tbOutput.Text = CompareMessages.TRUE + " - " + CompareMessages.IF + " " + CompareAngleMessages.ANGLE + " " + CompareMessages.IS + " ";
