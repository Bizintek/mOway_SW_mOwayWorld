...
{
    public partial class CompareBatteryForm : ActionForm
    {
        #region Attributes

        private CompareBatteryAction action;

        #endregion

        public CompareBatteryForm(CompareBatteryAction action)
        {
            InitializeComponent();
            this.helpTopic = CompareBattery.HelpTopic;
this.action = action;
        }
        ...
        {
            this.tbOutput.Text = CompareMessages.TRUE + " - " + CompareMessages.IF + " " + CompareBatteryMessages.BATTERY + " " + CompareMessages.IS + " ";
