...
{
    public class CompareBatteryAction : Conditional
    {
        #region Attributes
        ...
        public CompareBatteryAction(string key)
        {
            this.key = key;
        }

        public CompareBatteryAction(string key, ComparativeOp operation, Variable compareVariable, int compareValue)
        {
            this.key = key;
        ...
        public CompareBatteryAction(string key, XmlElement properties, System.Collections.Generic.SortedList<string, Variable> variables)
        {
            this.key = key;
        ...
        {
            return new CompareBatteryAction(this.key, this.operation, this.compareVariable, this.compareValue);
        }
        ...
        {
            writer.WriteLine(";************Module Compare Battery************************************");
            writer.WriteLine("");
            writer.WriteLine(";**********************************************************************");
            writer.WriteLine("");
