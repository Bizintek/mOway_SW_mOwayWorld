...
{
    public class CompareVariableAction : Conditional
    {
        #region Attributes
        ...
        public CompareVariableAction(string key)
        {
            this.key = key;
        }
        ...
        public CompareVariableAction(string key, XmlElement properties, System.Collections.Generic.SortedList<string, Variable> variables)
        {
            this.key = key;
        ...
        {
            if ((this.compareVariable == variable) || (this.variable == variable))
                return true;
            else
                return false;
        }
        ...
        {
            return new CompareVariableAction(this.key, this.variable, this.operation, this.compareVariable, this.compareValue);
        }
        ...
        {
            writer.WriteLine(";************Module Comparative*******************************************");
            writer.WriteLine("");
            writer.WriteLine(";************************************************************************");
            writer.WriteLine("");
        ...
        public override bool Simulate(MowayModel mowayModel)
        {
            ...
            modelValueAux = mowayModel.GetRegister(this.variable.Name).Value;
