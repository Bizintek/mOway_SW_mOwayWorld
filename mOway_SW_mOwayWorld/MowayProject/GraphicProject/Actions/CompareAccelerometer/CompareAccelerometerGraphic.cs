...
{
    public class CompareAccelerometerGraphic : GraphConditional
    {
        public override bool Selected
        {
            ...
            set
            {
                if (this.selected != value)
                {
                    this.selected = value;
                    if (this.selected)
                        this.Surface.Blit(new Surface(CompareAccelerometer.GraphicIconSelected));
                    else
                    {
        ...
        public CompareAccelerometerGraphic(string key)
            : base(key)
        {
        ...
        public CompareAccelerometerGraphic(string key, CompareAccelerometerAction element, Point center)
        ...
        {
            return new CompareAccelerometerGraphic(this.key, (CompareAccelerometerAction)this.element.Clone(), this.Center);
        }
    }
}
